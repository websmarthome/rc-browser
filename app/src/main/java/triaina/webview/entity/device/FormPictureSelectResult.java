...
public class FormPictureSelectResult implements Result {
	...
	@Exclude
	public static final Creator<FormPictureSelectResult> CREATOR = new Creator<FormPictureSelectResult>() {
        @Override
	...
	public static class FormFile implements Result {
		...
		@Exclude
		public static final Creator<FormFile> CREATOR = new Creator<FormFile>() {
	        @Override
