...
public class DeviceBridgeProxy {
    ...
    public static class WebViewBridgeCallback implements Callback<Result> {
        ...
        public static final Creator<WebViewBridgeCallback> CREATOR = new Creator<WebViewBridgeCallback>() {
            @Override
    ...
    public static class DummyCallback implements Callback<Result> {
        ...
        public static final Creator<DummyCallback> CREATOR = new Creator<DummyCallback>() {
            @Override
